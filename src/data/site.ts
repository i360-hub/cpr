...
export const site = {
  ...
  schema: {
    ...
    // Cities served, Fort Mill first then the SC towns nearest the shop; NC towns
    // follow and must never lead the list. Reinforces areaServed relevance; the
  ...
  // Fort Mill points at / — the homepage is the Fort Mill page.
